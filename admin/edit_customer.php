            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="../index.php" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder second sixth">Edit Data Customer</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2 second">Untuk Mengedit Data Customer,</h4>
              ...
              <div class="mb-3">
                ...
                <div class="mb-3 form-password-toggle">
                        ...
                        <select id="smallSelect" class="form-select form-select-sm eight" name="status">
