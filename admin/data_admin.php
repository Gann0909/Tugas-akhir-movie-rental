    ...
    if (toastEl) {
      ...
      toast.show();
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4 third"><span class="text-muted fw-light second">Data</span> Admin</h4>
              ...
              <div class="card first">
                <h5 class="card-header third"><span class="second">Table</span> Data Admin</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    <thead class="fouth">
                      <tr class="text-nowrap">
                        <th class="second">#</th>
                        <th class="second">Username</th>
                        <th class="second">Password</th>
        ...
        <?php foreach( $users as $row ): ?>
                    ...
                    <tbody class="fouth">
                      <tr>
                        ...
                        <td class="second"><?= $row["password"]; ?></td>
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu first">
                              <a class="dropdown-item second" href="edit_admin.php?id=<?= $row["id"]; ?>"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                              >
                              <a class="dropdown-item second" href="hapus_admin.php?id=<?= $row["id"]; ?>"
