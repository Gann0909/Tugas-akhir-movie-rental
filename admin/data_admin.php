      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="data_film.php" class="menu-link">
              <i class="menu-icon tf-icons bx bx-table"></i>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="edit_admin.php?id=<?= $row["id"]; ?>"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                              >
                              <a class="dropdown-item" href="hapus_admin.php?id=<?= $row["id"]; ?>"
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , Created By
                  <a href="https://themeselection.com" target="_blank" class="footer-link fw-bolder">Kelompok Movie Rental</a>
                </div>
              </div>
            </footer>
            <!-- / Footer -->
