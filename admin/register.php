...
>
  <head>
    ...
    <title>Register - Movie Rental Admin</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder second sixth">Register</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2 second">Jadilah bagian dari Movie Rental!</h4>
              ...
              <form id="formAuthentication" class="mb-3" action="" method="POST" autocomplete="off">
                ...
                <div class="mb-3 form-password-toggle">
                  <label class="form-label second" for="password">Password</label>
                ...
                <div class="mb-3 form-password-toggle">
                  <label class="form-label second" for="password">Konfirmasi Password</label>
                  <div class="input-group input-group-merge">
                    <input
                      type="password"
                      id="password"
                ...
                <button class="btn btn-danger d-grid w-100" type="submit" name="register">Daftar</button>
                <hr>
