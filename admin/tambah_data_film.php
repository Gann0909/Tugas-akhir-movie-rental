            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Tambah Film</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Untuk menambahkan film,</h4>
              ...
              <form id="formAuthentication" class="mb-3" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 form-password-toggle">
                  <label class="form-label" for="password">Gambar Film</label>
