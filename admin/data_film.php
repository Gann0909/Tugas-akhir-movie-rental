    ...
    if (toastEl) {
      ...
      toast.show();
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data</span> Film</h4>
              ...
              <!-- Responsive Table -->
              <div class="card">
                <h5 class="card-header">Table Film</h5>
                      ...
                      <tr>
                        ...
                        <td><div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="edit_data_film.php?id=<?= $row["film_id"]; ?>"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                              >
                              <a class="dropdown-item" href="hapus_film.php?id=<?= $row["film_id"]; ?>"
