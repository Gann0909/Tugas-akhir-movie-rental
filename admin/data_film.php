        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme first">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="dashboard.php" class="menu-link second">
              <i class="menu-icon tf-icons bx bx-table"></i>
                <div data-i18n="Misc">Data Penyewaan</div>
              </a>
    ...
    if (toastEl) {
      ...
      toast.show();
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4 third"><span class="text-muted fw-light second">Data</span> Film</h4>
              ...
              <div class="card first">
                <h5 class="card-header third"><span class="second">Table</span> Data Film</h5>
                  ...
                  <table class="table">
                    <thead class="fouth">
                      <tr class="text-nowrap">
                        ...
                        <th class="second">Genre Film</th>
                        <th class="second">Harga Sewa Film</th>
                        <th class="second">Rating Film</th>
                        <th class="second">Gambar Film</th>
                        <th class="second" >Tahun Rilis</th>
                    ...
                    <?php foreach( $film as $row ): ?>
                      <tr>
                        ...
                        <td class="second"><?= $row["judul_film"]; ?></td>
                        <td class="second"><?= $row["genre"]; ?></td>
                        <td class="second"><?= $row["harga_sewa"]; ?></td>
                        <td class="second"><?= $row["rating"]; ?></td>
                        <td>
                                <img src="../img/<?php echo $row["gambar"]; ?>" alt="" class="rounded-square" style="height: 55px; width: 65%; padding-left: 25px;"/></td>
                                <td class="second"><?php echo $row["tahun_rilis"]; ?></td>
                        <td><div class="dropdown">
                            <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown">
                              <i class="bx bx-dots-vertical-rounded second"></i>
                            </button>
                            <div class="dropdown-menu first">
                              <a class="dropdown-item second" href="edit_data_film.php?id=<?= $row["film_id"]; ?>"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                              >
                              <a class="dropdown-item second" href="hapus_film.php?id=<?= $row["film_id"]; ?>"
